...
The `v1.0.0-alpha4` and `v1.0.0-alpha5` release tags include manual overrides of generated code in `src` in order to resolve a downstream issue within [regen-network/groups-ui](https://github.com/RegenNetwork/groups-ui). For more information, see [#84](https://github.com/RegenNetwork/regen-js/pull/84).
